...
function [vDefldir ,segHeaderDir ,heightdir] = findunloaddir_FVM(zipContents,index,n)
...
string = sprintf('index/%d/segments/1/channels/capacitiveSensorHeight.dat',index);
for cell = 1 : n;   
   isequal=strcmp(zipContents{cell,1},string);
   if (isequal == 1);
