...
% 
% approach_X=FibrilData(fib).Approach{i,1}(:,1);
% approach_Y=FibrilData(fib).Approach{i,1}(:,2);
% retract_X=FibrilData(fib).Retract{i,1}(:,1);
% retract_Y=FibrilData(fib).Retract{i,1}(:,2);
